     ...
     */
                    readers: {
                        ...
                        "gmd": {
                            ...
                            "temporalElement":function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },                            
                            "EX_TemporalExtent":function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },                                                    
                            "identifier": function(node, obj) { 
                                 this.readChildNodes(node, obj);
                            },
                            "MD_Identifier": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },
                            "code": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },                            
                            ...
                            "distributor": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },
                            "MD_Distributor": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },                        
                            
                            "distributorTransferOptions": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },
                            ...
                            "descriptiveKeywords": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },
                            "MD_Keywords": function(node, obj) {
                                 this.readChildNodes(node, obj);
                            },
                            ...
                            "URL": function(node, obj) {
                                var name = node.localName || node.nodeName.split(":").pop(); 
                                name = this.getChainParentNode(node,"");                              
                                if (!(OpenLayers.Util.isArray(obj[name]))) {
                                    obj[name] = [];
                                }
                                var dc_element = {};
...
//                            }
                        ...
                        "gco": {
                            ...
                            "*": function(node, obj) {
                                var name = node.localName || node.nodeName.split(":").pop();                                  
                              //  var parentname= node.parentNode.localName || node.parentNodenodeName.split(":").pop();
